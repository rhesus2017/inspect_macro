...
def chrome_daum_blog(keyword, target, url):
    ...
    try:
        ...
        if control.Exists(5, 1):
            control.Click()
            control.SendKeys("https://search.daum.net/search?w=blog&nil_search=btn&DA=NTB&enc=utf8&q=")
        ...
        for page_no in range(1, 10 + 1):
            ...
            if control.Exists(2, 0.5):
                ...
                tab = auto.EditControl(value=url)
                if tab.Exists(10, 1):
                    time.sleep(3)
...
if __name__ == '__main__':
    chrome_daum_blog('로또블루', '7월 30일 주요 경제 뉴스 모음', 'https://teen21.tistory.com/48')
